...
/**
* CConman 猜测应该是ConnectionManagement 的缩写
* 主要负责网络连接等信息
*
*/
class CConnman
...
public:
    ...
    // DNS seed node is used to propagate bitcoin nodes' address to others.
    ...
    // a nonce was add in the ping message, the target peer would resply a pong message contains that nonce
