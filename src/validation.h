...
{
public:
    // hzx BlockMap unordered_map<uint256, CBlockIndex*>
 ...
 * disk, `m_dbview`.
 */
// hzx CoinsViews是访问utxo的集合,
/**
 * 在BitcoinCore中,用leveldb存储utxo集合
 * */
class CoinsViews
{
public:
...
/**
 * // CChainState专门存储所有与当前最长合法连相关的内容
